...
dnl     VIRTMAIL_MAILER_PATH = /usr/local/virtmail/bin/maildrop | anything else
...
dnl     VIRTMAIL_MAILDR_CONFIGDIR = /usr/local/virtmail/etc/rcs | /path/to/procmailrcs
...
define(`VIRTMAIL_MAILER_CONFIGDIR',`/usr/local/virtmail/etc/rcs')dnl
