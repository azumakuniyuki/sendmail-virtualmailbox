...
dnl ############################################################################
dnl #
APPENDDEF(`confENVDEF',`-D_PATH_SENDMAILCF=\"__SYSCONFDIR__/sendmail.cf\"')
APPENDDEF(`confENVDEF',`-D_DIR_SENDMAILCF=\"__SYSCONFDIR__/\"')
dnl # APPENDDEF(`confENVDEF',`-D_PATH_SENDMAILCF=\"/etc/mail/sendmail.cf\"')
dnl # APPENDDEF(`confENVDEF',`-D_DIR_SENDMAILCF=\"/etc/mail/\"')
APPENDDEF(`confENVDEF',`-D_PATH_SENDMAILPID=\"__LOCALSTATEDIR__/run/sendmail.pid\"')
APPENDDEF(`conf_smrsh_ENVDEF', `-DCMDDIR="\"__LOCALSTATEDIR__/adm/sm.bin\""')
...
dnl # APPENDDEF(`conf_sendmail_ENVDEV',`-DSM_CONF_SHM=1')dnl
...
define(`confMANROOTMAN',`__DATAROOTDIR__')dnl	# manual root directory
define(`confMANROOT',`__DATAROOTDIR__/man/man')dnl # manual root directory
